function varargout = gears_export(varargin)
% GEARS_EXPORT M-file for gears_export.fig
%      GEARS_EXPORT, by itself, creates a new GEARS_EXPORT or raises the existing
%      singleton*.
%
%      H = GEARS_EXPORT returns the handle to a new GEARS_EXPORT or the handle to
%      the existing singleton*.
%
%      GEARS_EXPORT('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GEARS_EXPORT.M with the given input arguments.
%
%      GEARS_EXPORT('Property','Value',...) creates a new GEARS_EXPORT or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before gears_export_OpeningFunction gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to gears_export_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help gears_export

% Last Modified by GUIDE v2.5 17-Sep-2002 16:11:17

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @gears_export_OpeningFcn, ...
                   'gui_OutputFcn',  @gears_export_OutputFcn, ...
                   'gui_LayoutFcn',  @gears_export_LayoutFcn, ...
                   'gui_Callback',   []);
...
% --- Executes just before gears_export is made visible.
function gears_export_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to gears_export (see VARARGIN)

% Choose default command line output for gears_export
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes gears_export wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = gears_export_OutputFcn(hObject, eventdata, handles)
...
phi_d=C;	%The pressure angle in degrees 
% ----------------------------------------------------------------------------
...
function h1 = gears_export_LayoutFcn(policy)
...
'Callback','gears_export(''edit_teeth_number_Callback'',gcbo,[],guidata(gcbo))',...
'ListboxTop',0,...
'Position',[18.4 28.3076923076923 16.2 1.61538461538462],...
'String','18',...
'Style','edit',...
'CreateFcn','gears_export(''edit_teeth_number_CreateFcn'',gcbo,[],guidata(gcbo))',...
...
'Units','characters',...
'BackgroundColor',[1 1 1],...
'Callback','gears_export(''edit_pressure_angle_Callback'',gcbo,[],guidata(gcbo))',...
'ListboxTop',0,...
'Position',[69.8 28.3076923076923 16.2 1.61538461538462],...
'String','25',...
'Style','edit',...
'CreateFcn','gears_export(''edit_pressure_angle_CreateFcn'',gcbo,[],guidata(gcbo))',...
...
'Units','characters',...
'BackgroundColor',[1 1 1],...
'Callback','gears_export(''edit_diametral_pitch_Callback'',gcbo,[],guidata(gcbo))',...
'ListboxTop',0,...
'Position',[43.8 28.3076923076923 16.2 1.61538461538462],...
'String','8',...
'Style','edit',...
'CreateFcn','gears_export(''edit_diametral_pitch_CreateFcn'',gcbo,[],guidata(gcbo))',...
...
'Parent',h1,...
'Units','characters',...
'Callback','gears_export(''pushbutton_plot_Callback'',gcbo,[],guidata(gcbo))',...
'ListboxTop',0,...
...
'Parent',h1,...
'Units','characters',...
'Callback','gears_export(''pushbutton_quit_Callback'',gcbo,[],guidata(gcbo))',...
'ListboxTop',0,...
...
elseif numargin > 3 & ischar(varargin{1}) & ishandle(varargin{2})
    % GEARS_EXPORT('CALLBACK',hObject,eventData,handles,...)
    gui_Create = 0;
else
    % GEARS_EXPORT(...)
